...
export const tempsQuestions: RawQuestion[] = [
  {
    question:
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "Passé et futur n'existent pas en eux-mêmes ; il n'y a que trois présents dans l'âme : la mémoire, l'attention et l'attente. Le temps est une « distension de l'âme ».",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Le temps n'est pas le mouvement, mais ce qui s'y mesure : sans changement perçu, pas de conscience du temps. Le temps est lié au mouvement.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Le temps spatialisé de la science juxtapose des instants ; la durée vécue est une continuité qualitative et indivisible, où le passé se conserve dans le présent.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Le temps n'est pas tiré de l'expérience : il est la forme de notre sens interne, à travers laquelle nous ordonnons toutes nos représentations.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Face à la fuite du temps et à la mort, la sagesse épicurienne invite à jouir du présent : « cueille le jour présent en te fiant le moins possible au lendemain ».",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Conscient que son temps est compté, l'homme donne sens et urgence à son existence : la mortalité n'est pas qu'une limite, elle est aussi ce qui fait prix du temps.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "On ne peut perdre ni le passé (qui n'est plus) ni l'avenir (qui n'est pas encore), mais seulement le présent : c'est lui qu'il faut habiter pleinement.",
  },
  {
    question:
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "Une heure d'ennui paraît interminable, une heure de plaisir trop courte : le temps psychologique ne se confond pas avec le temps uniforme des horloges.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Sans mémoire, pas de durée ni d'identité : le passé n'est pas aboli, il « grossit sans cesse » et s'engage dans chacun de nos actes présents.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "L'homme n'est pas une chose présente : il est ce qu'il se fait être, en avant de lui-même. L'avenir, comme possibilité, structure son existence.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Pour Aristote, le temps tient au mouvement réel ; pour Augustin et Kant, il est lié à l'âme ou à la sensibilité : tout l'enjeu est le statut du temps.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "L'instant ponctuel ne se vit pas : ce que nous éprouvons, c'est toujours une durée, un présent épais où se mêlent souvenir et attente.",
  },
  {
    question:
    ...
    correct: 0,
    explanation:
      "Le temps cyclique (éternel retour des saisons, des cités) s'oppose au temps linéaire judéo-chrétien puis moderne, orienté vers une fin (salut, progrès, émancipation).",
  },
];
